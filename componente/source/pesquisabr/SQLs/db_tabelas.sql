...
drop table pesquisabr.texto_pesquisa;
CREATE TABLE pesquisabr.texto_pesquisa (
    tipo_documento varchar(100) NULL COMMENT 'nome do tipo documento',
    id_documento varchar(100) NULL COMMENT 'id do documento',
    seq_documento int NOT NULL COMMENT 'seq do documento',
    texto longtext COMMENT 'texto pré processado do documento',
    tamanho_mapa int comment 'tamanho do mapa de pesquisa',
    tamanho_texto int comment 'tamanho do texto original',
    dthr timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'data de inclusão na tabela' ,
    KEY (id_documento, tipo_documento, seq_documento) USING CLUSTERED COLUMNSTORE,
...
######### não utilizada - apenas testes
drop table pesquisabr.testes;
CREATE TABLE pesquisabr.testes (
    seq bigint(11) NOT NULL AUTO_INCREMENT,
    texto longtext COMMENT 'conteúdo do texto',
    dthr timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'data de inclusão na tabela' ,
    KEY (seq) USING CLUSTERED COLUMNSTORE,
    FULLTEXT KEY (texto)
  );
...
######### não utilizada - apenas testes
drop table pesquisabr.palavras;
CREATE TABLE pesquisabr.palavras (
	palavra varchar(200) NOT NULL,
	e_palavra BOOL NULL,
	e_singular BOOL NULL,
	df int NULL,
	origem varchar(20) NULL,
	dthr DATETIME DEFAULT now() NULL,
	KEY (palavra) USING CLUSTERED COLUMNSTORE
);  
